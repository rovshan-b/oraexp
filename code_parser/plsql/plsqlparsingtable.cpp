...
action_6_PLS_E_O_F->stateOrRuleId = 3;
...
action_7_PLS_ID->stateOrRuleId = 21;
...
action_7_PLS_DOUBLEQUOTED_STRING->stateOrRuleId = 22;
...
action_8_PLS_ID->stateOrRuleId = 21;
...
action_8_PLS_DOUBLEQUOTED_STRING->stateOrRuleId = 22;
...
action_18_PLS_E_O_F->stateOrRuleId = 5;
action_18_PLS_E_O_F->symbolCount = 2;

ParsingTableAction * action_20_PLS_DOT = new ParsingTableAction();
action_20_PLS_DOT->actionType = ParsingTableAction::Shift;
action_20_PLS_DOT->stateOrRuleId = 29;
action_20_PLS_DOT->symbolCount = -1;

ParsingTableAction * action_20_PLS_E_O_F = new ParsingTableAction();
action_20_PLS_E_O_F->actionType = ParsingTableAction::Reduce;
action_20_PLS_E_O_F->stateOrRuleId = 10;
action_20_PLS_E_O_F->symbolCount = 1;

ParsingTableAction * action_21_PLS_DOT = new ParsingTableAction();
action_21_PLS_DOT->actionType = ParsingTableAction::Reduce;
action_21_PLS_DOT->stateOrRuleId = 11;
action_21_PLS_DOT->symbolCount = 1;

ParsingTableAction * action_21_PLS_E_O_F = new ParsingTableAction();
action_21_PLS_E_O_F->actionType = ParsingTableAction::Reduce;
action_21_PLS_E_O_F->stateOrRuleId = 11;
action_21_PLS_E_O_F->symbolCount = 1;

ParsingTableAction * action_27_75 = new ParsingTableAction();
action_27_75->actionType = ParsingTableAction::Reduce;
action_27_75->stateOrRuleId = 6;
action_27_75->symbolCount = 2;

ParsingTableAction * action_28_PLS_E_O_F = new ParsingTableAction();
action_28_PLS_E_O_F->actionType = ParsingTableAction::Reduce;
action_28_PLS_E_O_F->stateOrRuleId = 5;
action_28_PLS_E_O_F->symbolCount = 3;

ParsingTableAction * action_31_PLS_E_O_F = new ParsingTableAction();
action_31_PLS_E_O_F->actionType = ParsingTableAction::Reduce;
action_31_PLS_E_O_F->stateOrRuleId = 10;
action_31_PLS_E_O_F->symbolCount = 3;
...
row_19->stateId = 19;
row_19->ownsActions = false;
(*row_19->actions)[PLS_ID] = action_8_PLS_ID;
(*row_19->actions)[PLS_DOUBLEQUOTED_STRING] = action_8_PLS_DOUBLEQUOTED_STRING;
row_19->gotos[10] = 28;
row_19->gotos[11] = 20;
rows.append(row_19);
...
row_20->stateId = 20;
row_20->ownsActions = true;
(*row_20->actions)[PLS_DOT] = action_20_PLS_DOT;
(*row_20->actions)[PLS_E_O_F] = action_20_PLS_E_O_F;
rows.append(row_20);

ParsingTableRow *row_21 = new ParsingTableRow();
row_21->stateId = 21;
row_21->ownsActions = true;
(*row_21->actions)[PLS_DOT] = action_21_PLS_DOT;
...
(*row_22->actions)[PLS_DOT] = action_21_PLS_DOT;
(*row_22->actions)[PLS_E_O_F] = action_21_PLS_E_O_F;
rows.append(row_22);

ParsingTableRow *row_23 = new ParsingTableRow();
row_23->stateId = 23;
row_23->ownsActions = false;
(*row_23->actions)[PLS_E_O_F] = action_18_PLS_E_O_F;
rows.append(row_23);

ParsingTableRow *row_24 = new ParsingTableRow();
row_24->stateId = 24;
row_24->ownsActions = false;
(*row_24->actions)[PLS_E_O_F] = action_18_PLS_E_O_F;
rows.append(row_24);

ParsingTableRow *row_25 = new ParsingTableRow();
row_25->stateId = 25;
row_25->ownsActions = false;
(*row_25->actions)[PLS_E_O_F] = action_18_PLS_E_O_F;
rows.append(row_25);

ParsingTableRow *row_26 = new ParsingTableRow();
row_26->stateId = 26;
row_26->ownsActions = false;
(*row_26->actions)[PLS_ID] = action_8_PLS_ID;
(*row_26->actions)[PLS_DOUBLEQUOTED_STRING] = action_8_PLS_DOUBLEQUOTED_STRING;
row_26->gotos[10] = 30;
row_26->gotos[11] = 20;
rows.append(row_26);
...
row_27->stateId = 27;
row_27->ownsActions = true;
(*row_27->actions)[75] = action_27_75;
rows.append(row_27);

ParsingTableRow *row_28 = new ParsingTableRow();
row_28->stateId = 28;
row_28->ownsActions = true;
(*row_28->actions)[PLS_E_O_F] = action_28_PLS_E_O_F;
rows.append(row_28);
...
row_30->stateId = 30;
row_30->ownsActions = false;
(*row_30->actions)[PLS_E_O_F] = action_28_PLS_E_O_F;
rows.append(row_30);

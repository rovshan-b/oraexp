...
public:
    ...
    static QString generateDeleteStatement(const QString &schemaName, const QString &tableName, const QStringList &columns, const QStringList &whereColumns, OraExp::BindVarStyle bindStyle, bool includeSchema);
